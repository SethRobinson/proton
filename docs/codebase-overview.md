...
| `AI/` | LLM chat-completion client for OpenAI-compatible servers (see `docs/ai-llm.md`) | `LLMClient.h/.cpp` (LLMConversation + LLMClient; needs `Network/` + `util/cJSON.c` compiled in) |
