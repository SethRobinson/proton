...
class CL_VirtualFileSource_File : public CL_VirtualFileSource
{
/// \name Construction
/// \{

public:
	CL_VirtualFileSource_File(const CL_String &path);

	~CL_VirtualFileSource_File();
...
private:
	...
	CL_DirectoryScanner dir_scanner;
/// \}
};
