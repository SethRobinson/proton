...
public:
	CL_DirectoryScanner_Impl() { return; }

	virtual ~CL_DirectoryScanner_Impl() { return; }
...
public:
	virtual bool scan (const CL_String& pathname) =0;

	virtual bool scan (const CL_String& pathname, const CL_String& pattern) =0;

	/// \brief Returns the path of the directory being scanned.
	virtual CL_String get_directory_path() = 0;

	/// \brief Returns the name of the current found file.
	virtual CL_String get_name() = 0;
	...
	virtual CL_String get_pathname() = 0;
