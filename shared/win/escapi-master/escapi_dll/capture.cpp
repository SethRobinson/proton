...
// 			char temp[1024];
// 			sprintf(temp, "Count: %d - %d x %d, %x:%x:%x:%x %d %d\n", count, width, height, nativeGuid.Data1, nativeGuid.Data2, nativeGuid.Data3, nativeGuid.Data4, bestfit == count, besterror);
// 			OutputDebugStringA(temp);
// 			
		}

		//SETH's hack because my elgato will never fail and just scan all year
		break;
