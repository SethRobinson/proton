...
public:
	...
	boost::signals2::signal<void (VariantList*)> m_sig_tappoints_awarded; //called when awarded tap points
	boost::signals2::signal<void (VariantList*)> m_sig_offer_wall_closed; //ios only
