...
enum eVirtualKeys
{
    ...
    VIRTUAL_KEY_COMMAND, //on OSX.  equivalent would be windows key on Win, but I don't think we can really ever use that key..
    VIRTUAL_KEY_F1,
    VIRTUAL_KEY_F2,
    VIRTUAL_KEY_F3,
    VIRTUAL_KEY_F4,
    ...
    VIRTUAL_DPAD_BUTTON_LEFT,  //X on xbox controller
    VIRTUAL_DPAD_BUTTON_UP,    //Y on xbox controller
    VIRTUAL_DPAD_BUTTON_RIGHT, //B on xbox controller
    VIRTUAL_DPAD_BUTTON_DOWN,  //A on xbox controller
    VIRTUAL_DPAD_SELECT,
    VIRTUAL_DPAD_START,
