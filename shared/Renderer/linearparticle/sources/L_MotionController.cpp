...
L_MotionController::L_MotionController()
{
	...
	gravity = CL_Vec2f(0,0);
	motion_type = L_GRAVITY_ONLY;
}
...
void L_MotionController::set_2d_acceleration(const CL_Vec2f& vector)
{
...
void L_MotionController::set_point_acceleration(L_REAL x_pos, L_REAL y_pos, L_REAL magnitude)
{
	...
	acceleration_point_pos = CL_Vec2f(x_pos,y_pos);
...
void L_MotionController::set_gravity( const CL_Vec2f &vGravity )
{
	gravity = vGravity;
