...
#ifndef L_EFFECTEMITTER_H
#define L_EFFECTEMITTER_H
...
class L_EffectEmitter : public L_EffectManager
{

protected:
	L_ParticleEffect* effect_type;
...
public:
	...
	void Setup(L_ParticleEffect *effect);
