...
public:
	...
	L_ShootingEffect(int x, int y, const CL_Vec2f& shooting_vector_t, int period_t, int particle_per_period_t=1);

	/** Copy contructor */
	L_ShootingEffect(const L_ShootingEffect& cpy);

	/** Set shooting vector. */
	void set_shooting_vector(const CL_Vec2f& vector);
	...
	CL_Vec2f get_shooting_vector(void);
